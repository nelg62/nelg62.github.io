...
export const EXPERIENCE = [
  {
    ...
    start: "Feb 2026",
    link: "https://www.barfoot.co.nz/",
    end: "",
    tasks: [
      "Provide technical support to over 2,000 staff across the support centre and branch offices throughout New Zealand.",
      "Deliver Level 1 and Level 2 support via phone, email, and remote assistance troubleshooting.",
      "Troubleshoot hardware, software, VPN, Wi-Fi, account access, and business application issues, and property listing systems.",
      "Support staff using a wide range of real estate and business-critical systems, including listing, property management, and auction platforms.",
      "Provision, deploy, and decommission laptops and IT equipment, ensuring accurate asset tracking and secure recycling processes.",
      "Assist users with password resets, account access issues, and permission-related requests while collaborating with specialist teams for complex identity management tasks.",
      "Work closely with Web, API, Infrastructure, Networking, and third-party vendors to investigate incidents and resolve technical issues.",
      "Maintain support documentation and contribute to continuous improvements in service delivery and user experience.",
      "Assist with QA testing the Barfoot mobile app, taking notes using Testiny",
    ],
    tools: [
      "Phone system - Webex",
      "VPN - FortiClient VPN",
      "ticketing system - intercom",
      "google admin",
      "wifi management - Extreme Cloud IQ",
      "Desktop Central - Manage endpoints",
      "Snipe-IT - asset management",
      "logic monitor",
      "Grafana - IAM - user information portal",
      "barfoot custom apps - stafflist - listings, properties",
      "MRI Vault",
      "Supra Lockboxes",
      "JobTrackStudio - Campaign Track",
      "Confluence - knowledge articles - atlassian.net",
      "Google drive",
      "Message Media",
      "Auctions LIve",
      "REINZ",
      ...
      "Jira",
      "app testing - testiny",
      "Playing with google scripting",
      "Toshiba printers",
      "remote access - RealVNC - OnDemand Assist / usign Desktop Central",
      "MyInfo - barfoot app",
      "Listing Systym - Barfoot app",
      "properties - barfoot app",
      "Property Smarts",
      "Reapit Lettings / Inspect Real estate",
      "Reapit PM",
      "Reapit Sales",
      "SalesKit",
      "VaultRE",
